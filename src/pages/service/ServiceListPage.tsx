...
const ServiceListPage = (props: Props) => {
  ...
  const { services, selectedStatus,isLoading } = useSelector((state: RootState) => state.service)
  ...
  const filteredDevices = useMemo(() => {
    ...
    filteredDevices = filteredDevices.filter((services) =>
      services.tenDichVu.toLowerCase().includes(debouncedInput.toLowerCase())
    )
    return filteredDevices
  }, [services, selectedStatus, debouncedInput])
